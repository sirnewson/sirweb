...
const MediaModal = ({ isOpen, onClose, src, title, type }: MediaModalProps) => {
            ...
            {isOpen && (
                ...
                >
                    ...
                    >
                        ...
                        <div className="relative rounded-[12px] overflow-hidden shadow-2xl border border-white/10 w-full h-full bg-black flex items-center justify-center">
                            {type === 'video' ? (
                                <video
                                    src={src}
                                    controls
